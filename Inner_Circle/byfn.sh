...
docker exec cliPatient peer chaincode install -n referralcontract -v 1.0 -l node -p /opt/gopath/src/github.com/chaincode/referral
...
echo "========================="
docker exec cliPatient peer chaincode instantiate -o orderer.example.com:7050 --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem -C channel13 -n referralcontract -v 1.0 -c '{"Args":[]}' -P "AND ('PatientMSP.peer','GovtHosMSP.peer','PHCMSP.peer')"
