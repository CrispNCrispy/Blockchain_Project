...
async function main() {
    try {
        ...
        if (!userExists) {
            console.log('An identity for the user "user-govthos" does not exist in the wallet');
        ...
        await gateway.connect(ccpPath, { wallet, identity: 'user-govthos', discovery: { enabled: true, asLocalhost: true } });
